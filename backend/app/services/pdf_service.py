...
class PDFService:
    ...
    def extract_and_analyze(self, file_path: str) -> Dict:
        ...
        try:
            # Extract text
            text, title, abstract = self._extract_text_from_pdf(file_path)
    ...
    def _extract_text_from_pdf(self, file_path: str) -> Tuple[str, str, str]:
        ...
        try:
            ...
            title, abstract = self._extract_title_and_abstract(full_text, Path(file_path).name)
    ...
    def _extract_title_and_abstract(self, text: str, filename: str) -> Tuple[str, str]:
